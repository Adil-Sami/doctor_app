...
class SearchWalkinUserByIdPage extends StatefulWidget {
  @override
  _SearchWalkinUserByIdPageState createState() =>
      _SearchWalkinUserByIdPageState();
}

class _SearchWalkinUserByIdPageState extends State<SearchWalkinUserByIdPage> {
  List _userList = [];
  bool _isLoading = false;
  bool _isEnableBtn = true;
  bool _isSearchedBefore = false;
  TextEditingController _searchByIdController = TextEditingController();
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        WalkInEditUserProfilePage(userDetails: userList)),
              );
            },
            child: ListTile(
