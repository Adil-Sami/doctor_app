...
class WalkinRegisterPatient extends StatefulWidget {
  WalkinRegisterPatient({Key? key}) : super(key: key);

  @override
  _WalkinRegisterPatientState createState() => _WalkinRegisterPatientState();
}

class _WalkinRegisterPatientState extends State<WalkinRegisterPatient> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: CheckDeviceScreen().CheckDeviceScreenPT()
            ? IAppBars.commonAppBarKiosk(context, "Register Walk-in Patient")
            : IAppBars.commonAppBar(context, "Register Walk-in Patient"),
  ...
  _genderDropDown() {
    return Padding(
      ...
      child: DropdownButton<String>(
        ...
        //elevation: 5,
        style: TextStyle(color: Colors.white), iconEnabledColor: btnColor,
        items: <String>[
          'Gender',
          'Male',
          'Female',
          ...
          return DropdownMenuItem<String>(
            ...
            child: Text(
              ...
              style: TextStyle(
                  color: Colors.black,
                  fontSize:
                      CheckDeviceScreen().CheckDeviceScreenPT() ? 20 : 16),
            ),
          );
        }).toList(),
        hint: Text(
