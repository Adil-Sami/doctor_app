...
class SearchWalkinUserByNamePage extends StatefulWidget {
  @override
  _SearchWalkinUserByNamePageState createState() =>
      _SearchWalkinUserByNamePageState();
}

class _SearchWalkinUserByNamePageState
    extends State<SearchWalkinUserByNamePage> {
  List _userList = [];
