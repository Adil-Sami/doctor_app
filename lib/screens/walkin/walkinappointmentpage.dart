...
import 'package:demoadmin/screens/walkin/walkinchoosetimeslotpage.dart';
...
class WalkinAppointmentPage extends StatefulWidget {
  final doctId;
  final lunchOpTime;
  final lunchCloTime;
  final closingDate;
  ...
  WalkinAppointmentPage(
      ...
      : super(key: key);
  @override
  _WalkinAppointmentPageState createState() => _WalkinAppointmentPageState();
}

class _WalkinAppointmentPageState extends State<WalkinAppointmentPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: CheckDeviceScreen().CheckDeviceScreenPT()
            ? IAppBars.commonAppBarKiosk(context, widget.doctName)
            : IAppBars.commonAppBar(context, widget.doctName),
  ...
  void _checkStopBookingStatus() async {
    ...
    print("kpkpkpkpkpkpkpkpkpkpkpkpkpkpkpk $res"); //fetch settings details
    if (res != null) if (res["stopBooking"])
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => WalkinChooseTimeSlotPage(
            serviceName: "Offline",
            serviceTimeMin: int.parse(widget.serviceTime),
            openingTime: widget.copt,
            closingTime: widget.cclt,
            ...
            vspd: widget.vspd,
            wspd: widget.wspd,
            walkinActive: widget.walkinActive,
            videoActive: widget.videoActive
          ),
        ),
      );
    }
