...
class EditLabUserPage extends StatefulWidget {
  const EditLabUserPage({Key? key}) : super(key: key);

  @override
  _EditLabUserPageState createState() => _EditLabUserPageState();
}

class _EditLabUserPageState extends State<EditLabUserPage> {
  ...
  void getAndSetData() async {
    ...
    final laId = preferences.getString("laId") ?? "";
    this.laId = laId;

    final res = await LabAttenderService.getDataByApId(pid: laId);
    clinicId = res[0].clinicID;
    titleController.text = res[0].name;
