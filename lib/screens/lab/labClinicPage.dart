import 'package:demoadmin/screens/lab/labAttenderListPage.dart';
...
class LabClinicPage extends StatefulWidget {
  final cityId;
  final cityName;
  LabClinicPage({this.cityId, this.cityName});
  @override
  _LabClinicPageState createState() => _LabClinicPageState();
}

class _LabClinicPageState extends State<LabClinicPage> {
  @override
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => LabAttenderListPage(
