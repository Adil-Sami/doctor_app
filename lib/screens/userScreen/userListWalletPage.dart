...
import 'package:demoadmin/screens/userScreen/all_wallet_history_page.dart';
...
class UsersListWalletPage extends StatefulWidget {
  @override
  _UsersListWalletPageeState createState() => _UsersListWalletPageeState();
}

class _UsersListWalletPageeState extends State<UsersListWalletPage> {
          ...
          child: IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => AllHistoryWalletPage()),
              );
            },
          ),
  ...
  _handleByNameBtn() {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => SearchUserByNamePage(
              walletSearch:true)),
    );
  ...
  _handleByIdBtn() {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => SearchUserByIdPage(
              walletSearch:true)),
    );
  }
