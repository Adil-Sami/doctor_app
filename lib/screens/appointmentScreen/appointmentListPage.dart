...
class _AppointmentListPageState extends State<AppointmentListPage> {
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: SfDateRangePicker(
                      ...
                      initialSelectedRange: argsDate == null
                          ? null
                          : PickerDateRange(
      ...
      actions: <Widget>[
        ...
        _isLoading
            ...
            : Padding(
                padding: const EdgeInsets.only(right: 8.0),
                child: IconButton(
                    icon: Icon(Icons.merge_type_sharp), onPressed: cDialogBoxPdf
                    //  showDialogBoxByType
                    ))
      ],
    );
  ...
  Widget cardListBuilder() {
    return FutureBuilder(
        future: userType == "frontdesk"
            ? AppointmentService.getDataBYClinicId(
                _selectedStatus, _firstDate, _lastDate, limit, clinicId)
            : userType == "doctor"
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            new ElevatedButton(
                ...
                child: new Text("Today", style: TextStyle(color: Colors.white)),
                onPressed: () {
                  setState(() {
                    final newDate = new DateTime.now();
                    // print(newDate);
  ...
  void generatePdf() async {
    ...
    if (status.isDenied) {
      ...
      // print("Granted");
      if (userType == "frontdesk") {
        final appModel = await AppointmentService.getDataPdfByClinic(
            _selectedStatus, firstDate, lastDate, clinicId, limit); //**
...
// You can can also directly ask the permission about its status.
  ...
  Future<String> getClinicName(clinicId) async {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Row(
                          children: [
                            Text("Name: ${appointmentDetails[index].userId}",
                                style: TextStyle(
                        ...
                        FutureBuilder(
                            future:
                                getClinicName(appointmentDetails[index].clinicId),
