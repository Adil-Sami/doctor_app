    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          ...
          ToastMsg.showToastMsg("sorry doctor is not taking appointment");
        }
      },
      child: Container(
              ...
              Positioned.fill(
                  ...
                  child: Align(
                      ...
                      child: Container(
                        ...
                        color: primaryColor,
                        child: Center(
                          child: Text(    appointmentTypesDetails["title"] == "Online"
                              ? "Video Consultation ${widget.vspd}"
                              : "Hospital Visit ${widget.wspd}",
                              style: TextStyle(
                                color: Colors.white,
