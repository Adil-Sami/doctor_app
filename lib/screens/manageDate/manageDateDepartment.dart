import 'package:demoadmin/screens/manageDate/manageDoctorListPage.dart';
...
class ChooseManageDoctDepartmentListPage extends StatefulWidget {
  @override
  _ChooseManageDoctDepartmentListPageState createState() =>
      _ChooseManageDoctDepartmentListPageState();
}

class _ChooseManageDoctDepartmentListPageState
    extends State<ChooseManageDoctDepartmentListPage> {
  String clinicId = "";
  String cityId = "";
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ManageDoctorsList(
