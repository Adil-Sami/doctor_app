...
import 'package:demoadmin/screens/manageDate/manageDateClosePage.dart';
...
class ManageDoctorsList extends StatefulWidget {
  final clinicId;
  final cityId;
  final deptID;
  ManageDoctorsList({this.cityId, this.clinicId, this.deptID});
  @override
  _ManageDoctorsListState createState() => _ManageDoctorsListState();
}

class _ManageDoctorsListState extends State<ManageDoctorsList> {
  @override
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ManageAddDateToCloseBookingPage(
              doctId: listDetails.id.toString(),
            ),
          ),
        );
      },
