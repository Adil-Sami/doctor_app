...
class ShowReportImagePage extends StatefulWidget {
  final title;
  final imageUrls;
  ...
  ShowReportImagePage(
      ...
      : super(key: key);
  @override
  _ShowReportImagePagePageState createState() =>
      _ShowReportImagePagePageState();
}

class _ShowReportImagePagePageState extends State<ShowReportImagePage> {
