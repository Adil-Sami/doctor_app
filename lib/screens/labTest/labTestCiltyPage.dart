import 'package:demoadmin/screens/labTest/labClinicListPage.dart';
...
class LabTestCityListPage extends StatefulWidget {
  @override
  _LabTestCityListPageState createState() => _LabTestCityListPageState();
}

class _LabTestCityListPageState extends State<LabTestCityListPage> {
  @override
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => LabTestClinicPage(
