import 'package:demoadmin/screens/labTest/labTestListPage.dart';
...
class LabTestClinicPage extends StatefulWidget {
  final cityId;
  final cityName;
  LabTestClinicPage({this.cityId, this.cityName});
  @override
  _LabTestClinicPageState createState() => _LabTestClinicPageState();
}

class _LabTestClinicPageState extends State<LabTestClinicPage> {
  @override
