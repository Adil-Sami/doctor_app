...
class LabTestAllAppListPage extends StatefulWidget {
  @override
  _LabTestAllAppListPageState createState() => _LabTestAllAppListPageState();
}

class _LabTestAllAppListPageState extends State<LabTestAllAppListPage> {
  ...
  void generatePdf() async {
    ...
    if (status.isDenied) {
      ...
      final getLabList= await LabTestAppService.getAllData();
