...
class FDDepartmentListPage extends StatefulWidget {
  @override
  _FDDepartmentListPageState createState() => _FDDepartmentListPageState();
}

class _FDDepartmentListPageState extends State<FDDepartmentListPage> {
  String clinicId = "";
  String cityId = "";
